...
public class SmppAddressingProcessor implements Processor {

	private static final int SMPP_TON_E164 = 1;
	private static final int SMPP_TON_NATIONAL = 2;

	private Logger logger = LoggerFactory.getLogger(SmppAddressingProcessor.class);
	...
	public SmppAddressingProcessor(String smscCountry, String originHeaderName, String destinationHeaderName) {
	...
	private void handleDeliverSM(Exchange exchange) throws CamelExchangeException {
		handleSmscAddress(exchange, SmppConstants.SOURCE_ADDR, SmppConstants.SOURCE_ADDR_TON, originHeaderName);

		handleSmscAddress(exchange, SmppConstants.DEST_ADDR, SmppConstants.DEST_ADDR_TON, destinationHeaderName);
	}

	private void handleSmscAddress(Exchange exchange, String headerAddr, String headerTon, String headerE164)
